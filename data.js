...
skill[z][7] = ; // duration
skill[z][8] = ; //cooldown
skill[z][9] = ; //skill type 10-maneuver usw 15 special (artillery, support, squadron)
skill[z][10] = ; // special
skill[z][11] = ; //dps or effective buff
skill[z][12] = ; // name
skill[z][13] = type of dlc 15=arti 16=support 17= carrier yeah its redundant with 9 but i fucked up
*/
var skill = [];
...
skill[18][8] = [60,60,60,60];
skill[18][9] = 14;
skill[18][10] = [30,35,45,60]; //additional cp
skill[18][11] = [];
skill[18][12] = "Command field";
for (var i = 0; i <= 3; i += 1){
     skill[18][11][i] = (skill[18][7][i] * skill[18][5][i] / skill[18][8][i]); 
}
...
for (var i = 0; i <= 3; i +=1) {
    skill[20][11][i] = skill[20][10][i] * skill[20][7][i]/skill[20][8][i];
}
skill[20][13] = 15;
...
for (var i = 0; i <= 3; i +=1) {
    skill[21][11][i] = skill[21][2][i]/skill[21][8][i];
}
skill[21][13] = 15;
...
skill[22][2] = [400,460,580,760]; //damge
skill[22][3] = [0,0,0,0]; //Aoe
skill[22][8] = [60,57.5,52.5,45]; //cooldown
...
for (var i = 0; i <= 3; i += 1) {
    skill[22][11][i] = skill[22][2][i]/skill[22][8][i];
}
skill[22][13] = 15;
...
for (var i = 0; i <= 4; i +=1) {
    skill[23][11][i] = skill[23][10][i] * skill[23][7][i]/skill[23][8][i];
}
skill[23][13] = 15;
...
skill[24][9] = 15; //skill type 10-maneuver usw
...
skill[25][9] = 15; //skill type 10-maneuver usw
...
skill[26][9] = 15; //skill type 10-maneuver usw
...
skill[27][9] = 15; //skill type 10-maneuver usw
...
skill[28][9] = 15; //skill type 10-maneuver usw
...
skill[29][9] = 15; //skill type 10-maneuver usw
...
skill[31] = [];
skill[31][0] = "bo"; //id
skill[31][1] = "squadron_dmg"; //type
skill[31][2] = [750,1000,1250,1500]; //damge
skill[31][4] = 200; // range
skill[31][7] = [60,60,60,60]; // duration
skill[31][8] = [60,60,60,60]; //cooldown
skill[31][9] = 15; //skill type 10-maneuver usw
skill[31][11] = []; //dps or effective buff
skill[31][12] = "Bombers"; // name
for (var i = 0; i <= 4; i +=1) {
    skill[31][11][i] = skill[31][2][i] / skill[31][8][i];
}
skill[31][13] = 17;
...
/* SHIP info
    ...
    [13]defense
    [14]command
    [15]Special (artillery, support, squadron..)
    [15]DLC 1: yes 0: no
         */
